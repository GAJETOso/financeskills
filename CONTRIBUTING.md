...
Thanks for your interest in contributing to Finance Skills! This guide will help you add new skills or improve existing ones.

## Requesting a Skill

You can also suggest new skills by [opening a skill request](https://github.com/GAJETOso/financeskills/issues/new?template=skill-request.yml).
...
- **Directory name**: lowercase, hyphens only (e.g., `financial-analysis`)
...
├── evals/             # Required - evaluation benchmarks
│   └── evals.json
...
5. Submit a pull request using the appropriate template:
   - [New Skill](https://github.com/GAJETOso/financeskills/compare)
   - [Skill Update](https://github.com/GAJETOso/financeskills/compare)
